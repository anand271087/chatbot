...
lines = open('E:/Great Lakes/Chatbots/movie_lines.txt', encoding = 'utf8',errors ='ignore').read().split('\n')
conversations = open('E:/Great Lakes/Chatbots/movie_conversations.txt', encoding = 'utf8',errors ='ignore').read().split('\n')


#Creating a dictionary the maps the each line and its id
id2line = {}
for line in lines:
    _line = line.split(' +++$+++ ')
    if len(_line) == 5:
...
#Crate two dictionaries that map the questions words and the answers words to a unique integer
threshold = 20
questionwords2int = {}
word_number = 0
...
#Creating the inverse dictionary of the anserwords2int dictionary
...
#Translating all the questions and the answersinto integers
# and replacing the words thate were filtered out by <OUT>
questions_to_int =[]
for question in clean_questions:
    ints =[]
    for word in question.split():
...
for length in range(1 , 24):
    for i in enumerate(questions_to_int): #This will give index and the entire question
        if len(i[1]) == length:
...
#Creating placeholders for th inputs and targets
def model_inputs():
...
#Splitting the questions and answers into trainging and validation sets
        ...
        if batch_index % batch_index_check_validation_loss == 0  and batch_index > 0:
            ...
            for batch_index_validation,(padded_questions_in_batch,padded_answers_in_batch) in enumerate(split_into_batches(validation_questions,validation_answers,batch_size)):
                ...
                if average_validation_loss_error <= min(list_validation_loss_error):
                    ...
                    print('I donot speak better, I need to practice more')
